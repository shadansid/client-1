...
<Container size='xl' sx={{height:'40vh', borderRadius:'31px', display:'flex', justifyContent:'center',alignItems:'center', background:`url("/static/images/bg/bg.jpg")`, backgroundSize:'cover' , backgroundPosition:'center' }} >

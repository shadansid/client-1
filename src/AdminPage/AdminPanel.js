...
const AdminPanel = () => {
    ...
    return (
       ...
       <Link style={{textDecoration:'none', color:'black' , fontSize:'16px',marginLeft:'10px'}} to='/admin/allusers'>All Users</Link>
       </Grid>
     

       <Grid item xs={12} className='gridbox'>
       
       <Link style={{textDecoration:'none', color:'black' , fontSize:'16px',marginLeft:'10px'}} to='/admin/airdrop'>Airdrop</Link>
       </Grid>
     
       <Grid item xs={12} className='gridbox'>
       
       <Link style={{textDecoration:'none', color:'black' , fontSize:'16px',marginLeft:'10px'}} to='/admin/addcoin'>List Coin</Link>
       </Grid>
